...
namespace JFramework.Net
{
    public class NetworkTransport : Transport
    {
        ...
        private JFramework.Udp.Setting setting;
        private Client client;
        private Server server;

        private void Awake()
        {
            setting = new JFramework.Udp.Setting(sendBufferSize, receiveBufferSize, maxTransmitUnit, timeout, receivePacketSize, sendPacketSize, interval, resend, noDelay, congestion);
